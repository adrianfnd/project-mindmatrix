...
@section('content')
    <div class="container-fluid full-height d-flex justify-content-center align-items-center">
        <form enctype="multipart/form-data"
            action="@if (isset($universitas)) {{ route('admin.univeritas.dashboard.update.send') }} @else {{ route('admin.univeritas.dashboard.create.send') }} @endif"
            method="POST">
            @csrf
            @method('POST')
            ...
            <div class="card" style="width: 40rem;">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-5">
                            @if (isset($universitas))
                                <img id="previewImage" src="{{ $universitas['image_logo'] }}" alt="Card image"
                                    class="mb-3" height="300" width="200">
                                <input type="file" id="myFile" name="filename" accept="image/*">
                            @else
                                <img id="previewImage" src="https://via.placeholder.com/500x200" alt="Card image"
                                    class="mb-3" height="300" width="200">
                                <input type="file" id="myFile" name="filename" accept="image/*">
                            @endif
                        </div>
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="Masukan alamat anda">
@if (isset($universitas))
{{ $universitas['alamat'] }}
@endif
</textarea>
                                    ...
                                    <select class="form-select" name="jurusan[0]" aria-label="Default select example">
                                        ...
                                        @foreach ($jurusans as $jurusan)
                                            <option value="{{ $jurusan['id'] }}"
                                                @if ($value['id'] == $jurusan['id']) selected @endif>
