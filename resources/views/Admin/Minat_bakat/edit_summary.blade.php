                ...
                <div class="row mb-3">
                    <div class="col">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="keterangan" placeholder="Keterangan summary"
                                id="keterangan" style="height: 100px">{{$summary['keterangan']}}</textarea>
                        </div>
                    </div>
                </div>
                <div class="row mb-3">
                                    ...
                                    <div class="col">
                                        <select class="form-select" name="jurusan[0]" aria-label="Default select example">
                                            ...
                                            @foreach ($jurusans as $jurusan)
                                                <option value="{{$jurusan['id']}}" @if($jurusan['id'] == $jurusan_selectd['id']) selected @endif>{{$jurusan['nama_jurusan']}}</option>
                                            @endforeach
                                        </select>
                                    </div>
