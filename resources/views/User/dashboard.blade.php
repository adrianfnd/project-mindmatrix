...
<div class="container-fluid">
    ...
    <div class="row card mb-3">
        <div class="card-body">
            <div class="row mb-3">
                <div class="col-md-3">
                    <img src="{{asset('asset/image/undraw_pic_profile_re_7g2h.svg')}}" alt="foto_profile"
            ...
            @foreach ($tests as $test)
                <div class="col">
                    <div class="card" style="width:18rem">
                        <img src="{{asset('asset/image/undraw_design_inspiration_re_tftx.svg')}}" class="card-img-top p-4"
                            alt="image_minta_bakat">
                        <div class="card-body">
